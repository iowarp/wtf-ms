...
```bash
git add .research/DATA-INDEX.md .research/data/
git commit -m "data: register [N] files — [brief description]"
```
...
Data is now available to task executors.
Run `/wtfMS:execute-task [N]` to use it.
